...
#define M0_SET()				HAL_GPIO_WritePin(LoRa_M0_GPIO_Port, LoRa_M0_Pin, GPIO_PIN_SET);
#define M0_RESET()				HAL_GPIO_WritePin(LoRa_M0_GPIO_Port, LoRa_M0_Pin, GPIO_PIN_RESET);
...
#define M1_SET()				HAL_GPIO_WritePin(LoRa_M1_GPIO_Port, LoRa_M1_Pin, GPIO_PIN_SET);
#define M1_RESET()				HAL_GPIO_WritePin(LoRa_M1_GPIO_Port, LoRa_M1_Pin, GPIO_PIN_RESET);
